...
Плагин Inspector для ТИМ системы Renga разработан для более быстрой и легкой разработки программ и приложений, используя открытый API. Фактически данный плагин является аналогом всем известных плагинов для AutoCAD [плагин](ссылка 1), [плагин2](ссылка 2), или [RevitLookup]() для Revit, или [Tekla Lookup]() для TeklaStructures. 
